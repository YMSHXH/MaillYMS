...
public class HuiDan extends ScrollView {
    ...
    public HuiDan(Context context) {
        super(context);
    }
    public HuiDan(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public HuiDan(Context context, AttributeSet attrs, int defStyleAttr) {
